...
public class RPClient extends KeyAdapter implements WindowListener, MouseInputListener{
    ...
    public void startClient(Socket s)
    {
        ...
        while(true)
        {
            ...
            drawMan.draw();
            //g.setColor(new Color(rand.nextInt(240), rand.nextInt(240), rand.nextInt(240)));
            //if(rand.nextGaussian()<.1)
            //g.drawRect(rand.nextInt(drawing.getWidth()), rand.nextInt(drawing.getHeight()), rand.nextInt(10), rand.nextInt(10));
        }
    }
